...
urlpatterns = patterns('',
	...
	(r'^edit/(?P<project_pk>\d+)/$', 'ocradmin.projects.views.edit'),
	...
	(r'^show/(?P<project_pk>\d+)/$', 'ocradmin.projects.views.show'),
    (r'^update/(?P<project_pk>\d+)/$', 'ocradmin.projects.views.update'),
)
