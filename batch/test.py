...
class OcrBatchTest(TestCase):
    ...
    def test_convert_action_tess(self):
        ...
        """
        self._test_batch_action({"engine": "tesseract", "lmodel": "Default Tesseract English"})        
    ...
    def test_results_action(self):
        ...
        exists.
        """
        r = self.client.get("/batch/results/1")
        self.assert_(r.content, "No content returned")
        content = simplejson.loads(r.content)        
        self.assertEqual(content[0]["fields"]["page"], os.path.basename(TESTFILE))
